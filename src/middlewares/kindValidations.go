...
type (
	KindCreateParams struct {
		Name string `json:"name" validate:"required,lowercase,min=3,startsnotwith= ,endsnotwith= ,alpha"`
	}
...
func KindCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		// obteniendo body json
		body := &KindCreateParams{}
